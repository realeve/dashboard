...
const Index = ({ setHide, hide, panel, selectedPanel, onRemove, dispatch, ...props }) => {
  ...
  const LayerItem = ({ isThumb, item, dispatch, idx }) => {
        ...
        >
          {item.hide && (
            <i
              ...
              onClick={() => {
                handleAction(MENU_ACTIONS.HIDE, [idx]);
              }}
            />
          )}
          {item.lock && (
            <i
              ...
              onClick={() => {
                handleAction(MENU_ACTIONS.LOCK, [idx]);
              }}
            />
          )}
        </div>
                    ...
                    {(provided, snapshot) => (
                      ...
                      >
                        <ContextMenuTrigger
                          ...
                          collect={(props) => props}
                        >
                          <LayerItem idx={idx} item={item} isThumb={isThumb} dispatch={dispatch} />
                        </ContextMenuTrigger>
                      </li>
                    )}
                  </Draggable>
