// import cbpc from './getDefaultTheme';
// export default cbpc;
export default {
  ...
  geometries: {
    ...
    point: {
      circle: {
        default: {
          style: { fill: '#5B8FF9', r: 4, stroke: '#000', lineWidth: 1, fillOpacity: 0.95 },
        },
        active: { style: { stroke: '#ddd', r: 4, fillOpacity: 1, lineWidth: 2 } },
        inactive: { style: { fillOpacity: 0.3, strokeOpacity: 0.3 } },
        selected: { style: { stroke: '#FFFFFF', lineWidth: 2 } },
      },
      square: {
      ...
      'hollow-circle': {
        default: {
          style: { fill: '#000', lineWidth: 1, stroke: '#5B8FF9', strokeOpacity: 0.95, r: 4 },
        },
  ...
  components: {
    ...
    legend: {
      ...
      continuous: {
        ...
        rail: {
          ...
          size: 12,
          defaultLength: 100,
          style: { fill: '#262626', stroke: null, lineWidth: 0 },
        },
        label: {
          align: 'rail',
          spacing: 4,
    ...
    annotation: {
      ...
      region: {
        top: false,
        style: { lineWidth: 0, stroke: null, fill: '#FFFFFF', fillOpacity: 0.06 },
        animate: true,
      },
    ...
    slider: { common: { padding: [8, 8, 8, 8] } },
    scrollbar: { common: { padding: [8, 8, 8, 8] } },
  },
  labels: {
    offset: 12,
    style: {
